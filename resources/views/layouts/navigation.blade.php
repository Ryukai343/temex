<nav class="navbar navbar-expand-xl navbar-dark bg-dark position-fixed z-3" >
    <div class="container-fluid">
        <a href="index.html" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-body-emphasis text-decoration-none logo">
        ...
        <div class="collapse navbar-collapse" id="navbar">
            <ul class="navbar-nav me-auto mb-2 mb-md-0">
                ...
                <li class="nav-item"><a href="{{ url('/items') }}" class="nav-link">Fotogaléria</a></li>
            ...
            <ul class="navbar-nav mr-3  nav-pills nav-fill d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                @if (Route::has('login'))
                    @auth
                        <li class="nav-item m-2"><a href="{{ url('/dashboard') }}" class="btn btn-outline-light ">Dashboard</a></li>
                        <li class="nav-item m-2"><a href="{{ route('logout') }}" class="btn btn-outline-light ">Odhlásenie</a></li>
